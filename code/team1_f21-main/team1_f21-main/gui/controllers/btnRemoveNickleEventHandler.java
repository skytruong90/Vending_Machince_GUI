...
public class btnRemoveNickleEventHandler implements EventHandler<ActionEvent> {
	@Override
	public void handle(ActionEvent event) 
	{
		try {
			if(Main.vm.getVMs()[Main.vmIndex].getNumNickels()!=0) {
				Main.vm.getVMs()[Main.vmIndex].removeNickels_Technician(1);
