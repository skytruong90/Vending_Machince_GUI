...
public class btnRemoveDimeEventHandler implements EventHandler<ActionEvent> {
	@Override
	public void handle(ActionEvent event) 
	{
		try {
			if(Main.vm.getVMs()[Main.vmIndex].getNumDimes()!=0) {
				Main.vm.getVMs()[Main.vmIndex].removeDimes_Technician(1);
